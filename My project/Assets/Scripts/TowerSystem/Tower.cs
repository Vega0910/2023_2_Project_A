...
public class Tower : MonoBehaviour
{
    ...
    public Collider[] colliderInRange;          //공격 범위 안에 들어오는Collider 배열

    public List<EnemyConroller> enemiesInRange = new List<EnemyConroller>();    //Collider 배열을 통해서 받은 Enemy Controller List
    ...
    void Update()
    {
        ...
        if(checkCounter <= 0)
        {
            ...
            {
                enemiesInRange.Add(col.GetComponent<EnemyConroller>());     //EnemyController를 받아와서 List에 넣는다
            }
